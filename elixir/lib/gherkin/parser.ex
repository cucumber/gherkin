...
TokenMatcher.match?(EOF , line, context) -> 
  ...
  defp match_token(%Line{} = line, %ParserContext{state: 51} = context) do
    cond do
TokenMatcher.match?(EOF , line, context) -> 
              TokenMatcher.parse(EOF , line, context) |>
                          AstBuilder.end_rule(DataTable) |>
  ...
  defp match_token(%Line{} = line, %ParserContext{state: 52} = context) do
    cond do
TokenMatcher.match?(DocStringSeparator , line, context) -> 
              TokenMatcher.parse(DocStringSeparator , line, context) |>
                          AstBuilder.build() |>

          update_next_state(53)
          TokenMatcher.match?(Other , line, context) -> 
              TokenMatcher.parse(Other , line, context) |>
                          AstBuilder.build() |>
  ...
  defp match_token(%Line{} = line, %ParserContext{state: 53} = context) do
    cond do
TokenMatcher.match?(EOF , line, context) -> 
              TokenMatcher.parse(EOF , line, context) |>
                          AstBuilder.end_rule(DocString) |>
  ...
  defp match_token(%Line{} = line, %ParserContext{state: 54} = context) do
    cond do
TokenMatcher.match?(EOF , line, context) -> 
              TokenMatcher.parse(EOF , line, context) |>
                          AstBuilder.end_rule(DataTable) |>
