...
[![pub package](https://img.shields.io/pub/v/cucumber_gherkin.svg)](https://pub.dev/packages/cucumber_gherkin)
...
See the [example](https://github.com/cucumber/gherkin/blob/main/dart/example/dart_example.dart) for parsing a feature source.
