...
class TokenMatcher:
    ...
    def _match_DocStringSeparator(self, token: Token, separator: str, is_open: bool) -> bool:
    ...
    def _match_title_line(self, token: Token, token_type: str, keywords: Iterable[str]) -> bool:
    ...
    def _change_dialect(self, dialect_name: str, location: Location | None = None) -> None:
