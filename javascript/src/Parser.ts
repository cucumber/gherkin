...
export default class Parser<AstNode> {
  ...
  private matchTokenAt_51(token: IToken<TokenType>, context: Context) {
    if(this.match_EOF(context, token)) {
      this.endRule(context);
      this.endRule(context);
      this.endRule(context);
  ...
  private matchTokenAt_52(token: IToken<TokenType>, context: Context) {
    if(this.match_DocStringSeparator(context, token)) {
      this.build(context, token);
      return 53;
    }
  ...
  private matchTokenAt_53(token: IToken<TokenType>, context: Context) {
    if(this.match_EOF(context, token)) {
      this.endRule(context);
      this.endRule(context);
      this.endRule(context);
  ...
  private matchTokenAt_54(token: IToken<TokenType>, context: Context) {
    if(this.match_EOF(context, token)) {
      this.endRule(context);
      this.endRule(context);
      this.endRule(context);
